		...
		"filters": [
			[
				...
				(
					...
					"Quotation Item-income_account-mandatory_depends_on",
					...
					"Sales Order Item-income_account-mandatory_depends_on",
					...
					"Sales Invoice Item-income_account-mandatory_depends_on",
				),
			]
		],
	},
