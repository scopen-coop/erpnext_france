...
const export_data = (frm) => {
  let get_template_url =
    "/api/method/erpnext_france.erpnext_france.doctype.accounting_export.exporter.export_data";
  var export_params = () => {
    return {
      ...
      included_already_exported_document:
        frm.doc.included_already_exported_document,
    };
  };
