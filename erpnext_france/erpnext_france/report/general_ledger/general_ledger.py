...
def get_gl_entries(filters, accounting_dimensions):
	...
	if filters.get("group_by") == "Group by Voucher":
		order_by_statement = gl_entries.orderby(gle.posting_date, gle.voucher_type, gle.voucher_no)
	if filters.get("group_by") == "Group by Account":
		order_by_statement = gl_entries.orderby(gle.account, gle.posting_date, gle.creation)
...
def get_conditions(filters, gle, gl_entries):
	...
	if filters.get("against_voucher_no"):
		filters_query = filters_query.where(gle.against_voucher == filters.against_voucher_no)
